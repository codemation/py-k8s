...
class FormMgr:
    def POST(self, session_module_returnForm):
        ...
        if module == 'ConfigMgr':
            ...
            print (FileToParseObj)
            print (FileToParseObj.name)
            print (FileToParseObj.FormMgr.GetFormInputs())
...
class LoadConfig:
    def GET(self, session):
        ...
        for fileIndex in GetConfigFileDict:
            ...
            #Case_File = WebSesCh.InstanceList[int(session)].ava.FilesAvailableToLoad[key].split('/')
